...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-3300631-9"></script>
    <script>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="bbb">Some cats are bouncier than others. More force = more bounce—use a gentle touch if you're losing cats. A cat at rest does not always remain at rest. It rains year-round but sometimes there is snow. Resize or reload to change background
                    color. <a class="uhhh" href="https://cat-bounce.com">Reset</a> to retrieve cats. Remember: more force = more bounce.</p>

                <p class="ccc">
                    <a class="site" href="about/index.html">About</a>&nbsp; &#8226;&nbsp;
                    <a class="site" href="about/index.html#whycats">Why Cats?</a>
                </p>
            </div>
